...
const getCleanOrigin = (url?: string) => url ? url.replace(/\/$/, '') : null;
const prodOrigin = getCleanOrigin(process.env.FRONTEND_ORIGIN) || getCleanOrigin(process.env.FRONTEND_URL);
